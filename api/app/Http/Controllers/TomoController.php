...
class TomoController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('tomos.index', compact('tomos', 'mangas', 'editoriales', 'nextTomos'));
    }
    public function store(Request $request)
{
    ...
    if ($lastTomo) {
        // Para tomos posteriores: la fecha debe ser mayor o igual al mínimo y menor a hoy
        $rules['fecha_publicacion'] = "required|date|after_or_equal:$minFecha|before:" . date('Y-m-d');
    } else {
        // Para el primer tomo: cualquier fecha anterior a hoy
        $rules['fecha_publicacion'] = "required|date|before:" . date('Y-m-d');
    }
